...
void main() {
  print('Switcheroo.dart client mod initialized!');
  ...
  developer.registerExtension('ext.redstone.scheduleFrame',
      (method, params) async {
    SchedulerBinding.instance.scheduleFrame();
    return developer.ServiceExtensionResponse.result('{}');
  });

  print('Switcheroo.dart client mod ready! Flutter UI initialized.');
}
      ...
      home: McTheme(
        ...
        child: GuiRouter(
          routes: [
            ...
            // GuiRoute(
            //   containerId: 'switcheroo_dart:my_container',
